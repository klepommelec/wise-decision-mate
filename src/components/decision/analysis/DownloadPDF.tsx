...
export function DownloadPDF({
  ...
  return <Button variant="default" onClick={handleDownload} disabled={isDownloading} className="gap-2 rounded-full text-gray-900 bg-lime-400 hover:bg-lime-500 font-medium">
