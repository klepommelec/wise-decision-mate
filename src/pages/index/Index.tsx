...
const Index = () => {
  ...
  const renderWelcomeScreen = () => {
    ...
    return <motion.div className="text-center mb-16 relative z-10" {...pageTransition}>
  ...
  return <div className="flex flex-col min-h-screen lovable-gradient-bg" ref={contentRef}>
      <div className="flex-1 flex flex-col relative py-0">
        <div className="relative z-10 flex-1 flex flex-col">
          <AnimatePresence mode="wait">
            {step === 'decision' && <motion.div key="decision" className="flex-1 flex flex-col items-center justify-center py-0" {...pageTransition}>
            ...
            {step !== 'decision' && <Container key="other-steps">
                <motion.div className="w-full max-w-2xl mx-auto" {...pageTransition}>
                  {step === 'criteria' && <div>
          ...
          {user && step === 'decision' && !existingDecision && <div className="w-full mt-auto decisions-gradient-overlay">
