      ...
      <section className="min-h-screen relative overflow-hidden flex flex-col lg:flex-row">
        <div className="w-full flex items-center justify-center bg-gradient-to-br from-white to-lime-50">
          ...
          <div className="hidden lg:block absolute top-0 right-0 w-1/3 h-full">
            <img alt="Main droite" src="/lovable-uploads/49017462-c901-45f8-9cdd-2c12f141987a.png" className="absolute top-40 right-40 w-full max-w-sm opacity-70 object-contain z-0" />
          </div>
          
          <div className="hidden lg:block absolute bottom-0 left-0 w-1/3 h-full">
            <img src="/lovable-uploads/48468dde-ce5d-47a7-8c02-3c1640b44558.png" alt="Main gauche" className="absolute bottom-10 left-40 w-full max-w-sm opacity-70 object-contain z-0" />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-500 p-0"><Button variant="link" onClick={() => navigate("/about")}>À propos</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link" onClick={() => navigate("/help")}>Guide d'utilisation</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link">Fonctionnalités</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link">Tarifs</Button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-500 p-0"><Button variant="link">Blog</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link">Tutoriels</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link">FAQ</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link">Support</Button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-500 p-0"><Button variant="link">Conditions d'utilisation</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link">Politique de confidentialité</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link">Mentions légales</Button></li>
                <li className="text-gray-500 p-0"><Button variant="link">Cookies</Button></li>
              </ul>
            </div>
          </div>
