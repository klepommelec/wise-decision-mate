      ...
      <section className="min-h-screen relative overflow-hidden flex flex-col lg:flex-row">
        <div className="w-full flex items-center justify-center bg-gradient-to-br from-white to-lime-50 relative">
          ...
          <div className="hidden lg:block absolute top-0 right-0 w-1/3 h-full">
            <img alt="Main droite" src="/lovable-uploads/49017462-c901-45f8-9cdd-2c12f141987a.png" className="absolute top-40 right-30 w-full max-w-sm opacity-70 object-contain z-0" />
          </div>
          
          <div className="hidden lg:block absolute bottom-0 left-0 w-1/3 h-full">
            <img src="/lovable-uploads/48468dde-ce5d-47a7-8c02-3c1640b44558.png" alt="Main gauche" className="absolute bottom-10 left-30 w-full max-w-sm opacity-70 object-contain z-0" />
          </div>
        </div>
      </section>
